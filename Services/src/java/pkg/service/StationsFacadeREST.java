 ...
 */
@javax.ejb.Stateless
@javax.ws.rs.Path("pkg.stations")
public class StationsFacadeREST extends AbstractFacade<Stations> {

    @PersistenceContext(unitName = "ServicePU")
    private EntityManager em;

    public StationsFacadeREST() {
    ...
    public void create(Stations entity) {
        super.create(entity);
    }
    ...
    @javax.ws.rs.Path("{id}")
    @javax.ws.rs.Consumes({javax.ws.rs.core.MediaType.APPLICATION_XML, javax.ws.rs.core.MediaType.APPLICATION_JSON})
    public void edit(@javax.ws.rs.PathParam("id") Integer id, Stations entity) {
        super.edit(entity);
    }
    ...
    public Stations find(@javax.ws.rs.PathParam("id") Integer id) {
    ...
    @javax.ws.rs.Produces({javax.ws.rs.core.MediaType.APPLICATION_XML, javax.ws.rs.core.MediaType.APPLICATION_JSON})
    public List<Stations> findRange(@javax.ws.rs.PathParam("from") Integer from, @javax.ws.rs.PathParam("to") Integer to) {
